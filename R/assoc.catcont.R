assoc.catcont <- function(x,y,nperm=1000) {
  ...
  return(list('eta.squared'=round(eta.squared,3), 'permutation.pvalue'=permutation.pvalue, 'cor.coeff'=cor.coeff))
}
