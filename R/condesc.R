...
condesc <- function(y,x,min.cor=NULL,nperm=10,distrib="asympt"){
  ...
  res <- list(variables=GDAtools::assoc.yx(y,x,xx=FALSE,nperm=nperm,distrib=distrib)$YX, categories=categories)
  return(res)
}
