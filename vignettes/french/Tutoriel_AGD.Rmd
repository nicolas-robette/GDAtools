...
condesc(mca$ind$coord[,1], Taste[,c("Gender","Age","Educ")], dec=c(3,3,3,3))$categories
```

```{r condesc1bis, echo=FALSE}
knitr::kable(condesc(mca$ind$coord[,1], Taste[,c("Gender","Age","Educ")], dec=c(3,3,3,3))$categories, row.names=FALSE)
```
