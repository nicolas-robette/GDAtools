...
On notera d'aileurs que si on fait ce travail de manière minutieuse, en y ajoutant éventuellement l'analyse descriptive des relations entre trois ou quatre variables, on s'aperçoit souvent que le surplus de connaissance apporté par les modèles de régression est assez limité.  
\
