...
It can be seen here that the first two axes capture most of the information. In the following we will therefore concentrate on the plane formed by axes 1 and 2.
