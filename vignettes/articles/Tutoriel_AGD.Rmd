...
Les biplots d'une analyse des correspondances non symétrique reflètent la structure de dépendance du tableau de contingence et ne doivent donc pas être interprétés comme les plans d'une analyse des correspondances standard. Un premier principe est que le graphique affiche les profils-lignes centrés. Un deuxième principe est que les relations entre les lignes et les colonnes
...
On constate le fait de savoir que les tâches domestiques concernent la lessive ou la préparation des repas "augmente les performances de prédiction" de tâches féminines. Les réparations sont associées aux tâches masculines et l'organisation des vacances aux tâches conjointes.
